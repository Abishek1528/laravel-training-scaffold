<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Edit Task: :title', ['title' => $task->title]) }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('tasks.update', $task) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" :value="old('title', $task->title)" autofocus />
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <a href="{{ route('projects.show', $task->project_id) }}" class="text-sm text-gray-600 hover:text-gray-900 underline">
                                {{ __('Cancel') }}
                            </a>
                            <x-primary-button>
                                {{ __('Update Task') }}
